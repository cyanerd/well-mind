      ...
      <div className="about-section-background">
        <div className="about-section-second-background">
          <div className="about-section section">
            <div className="row-1">
              <h2>Обретите гармонию,<br/> не переплачивая за психологов</h2>
              <div className="text">
                Устали от постоянного стресса, исчерпали свой внутренний ресурс или просто хотите наладить отношения с близкими?
              </div>
              <Link to="/test" className="btn hide-mobile">Подобрать программу</Link>
            </div>
            <div className="row-2">
              <div className="text">
        ...
        <div className="row-4">
          <div>
            ...
            <div className="text">
              ...
              <p><b>Только дипломированные специалисты</b> с реальным опытом работы, прошедшие собеседование с командой Well-mind!</p>
              <p>Формат занятий на выбор:<br/> <i>очно или онлайн</i></p>
            </div>
            <a href="/" className="btn hide-mobile">Подобрать психолога</a>
          </div>
        </div>
        <a href="/" className="btn hide-desktop">Подобрать психолога</a>
      </div>
